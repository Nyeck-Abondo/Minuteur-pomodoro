...
namespace App {
    namespace Statistic {
        ...
        class stats {
            ...
            void WorkSessionComplete(int& minutes, float& seconde, int sessionNumber, int workminute,int workseconde, int restminute, int restseconde, int longRestMinutes, int longRestSecondes);
